...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-2.6-kirby-problem-2.6-ff3f86e7-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-2.6"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-2.6-kirby-problem-2.6-ff3f86e7-v1",
      "problem_contract_sha256": "9d1ad1f9722f96d6b552b3825cc73824aafc99dbec134dd8946f1d9756d69472",
      "problem_id": "problem:um-kp-2.6-kirby-problem-2.6-ff3f86e7",
      "route_id": "route:um-kp-2.6-kirby-problem-2.6-ff3f86e7-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-2.6-kirby-problem-2.6-ff3f86e7-source-fidelity-01",
      "graph_id": "graph:um-kp-2.6-kirby-problem-2.6-ff3f86e7-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-2.6-kirby-problem-2.6-ff3f86e7-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-2.6-kirby-problem-2.6-ff3f86e7-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Give a classification or enumeration of the finite-index sub- groups of $\\operatorname{Mod}(S_{g})$ that are generated by Dehn twists, Dehn multitwists, or powers thereof. Which of these subgroups are “geometrically meaningful”, in the sense that they are given as the stabilizers of some kind of geometric or topological struc- ture on the surface? Conversely, when is a geometrically meaningful subgroup (not necessarily of finite index) generated by powers of Dehn multitwists?"
          },
          "statement_sha256": "4f7ebd924e26b3fcbf8c804766f7be580dc1eb10fafe622727c478fd8049aaa1"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-2.6-kirby-problem-2.6-ff3f86e7-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-2.6-kirby-problem-2.6-ff3f86e7-root",
      "route_id": "route:um-kp-2.6-kirby-problem-2.6-ff3f86e7-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-2.6-293d6b41f176",
        "url": "https://www.unsolvedmath.com/problems/KP-2.6"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
